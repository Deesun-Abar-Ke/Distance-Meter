...
if(distance_cm<30){digitalWrite(led6, HIGH);}
else{digitalWrite(led6, LOW);}

if(distance_cm<25){digitalWrite(led5, HIGH);}
else{digitalWrite(led5, LOW);}

if(distance_cm<20){digitalWrite(led4, HIGH);}
else{digitalWrite(led4, LOW);}

if(distance_cm<15){digitalWrite(led3, HIGH);}
else{digitalWrite(led3, LOW);}

if(distance_cm<10){digitalWrite(led2, HIGH);}
else{digitalWrite(led2, LOW);}

if(distance_cm<5){digitalWrite(led1, HIGH);}
